...
namespace HRM_API.Migrations
{
    ...
    [Migration("20230324031305_TblBank")]
    partial class TblBank
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMSystem.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.EmployeeBasiceInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HRMSystem.Models.TblBank", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblBankBranch", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblBloodGroup", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblBusinessUnit", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblCountry", b =>
                {
                    b.Property<long>("IntCountryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HRMSystem.Models.TblDistrict", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblDivision", b =>
                {
                    b.Property<long>("IntDivisionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HRMSystem.Models.TblEducationDegree", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblEmployeBankInformation", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblEmployeeBasicInfo", b =>
                {
                    b.Property<long>("IntEmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HRMSystem.Models.TblEmployeeDepartment", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblEmployeeDesignation", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblEmploymentType", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblLevelOfEducation", b =>
                {
                    b.Property<long>("IntLevelOfEducationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HRMSystem.Models.TblLineManager", b =>
                {
                    b.Property<long>("LineManagerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HRMSystem.Models.TblPosition", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblPositionGroup", b =>
                {
                    b.Property<long>("IntPositionGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HRMSystem.Models.TblSupervisor", b =>
                {
            ...
            modelBuilder.Entity("HRMSystem.Models.TblWorkplaceGroup", b =>
                {
            ...
            modelBuilder.Entity("HRM_API.Models.TblEmployeeGrade", b =>
                {
                    ...
                    b.HasIndex("IntAccountId");

                    b.HasIndex("IntPositionGroupId");

                    b.ToTable("EmployeeGrades");
                });

            modelBuilder.Entity("HRM_API.Models.TblEmploymentStatus", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "cefdea51-b6fc-4cb6-9558-6a77be441620",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "fdd776b7-b97a-49c5-b68d-0c98843f5796",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("HRMSystem.Models.TblBankBranch", b =>
                {
                    b.HasOne("HRMSystem.Models.TblBank", "TblBank")
                        .WithMany("TblBankBranches")
                        .HasForeignKey("IntBankId");

                    b.HasOne("HRMSystem.Models.TblCountry", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMSystem.Models.TblDistrict", b =>
                {
                    ...
                    b.HasOne("HRMSystem.Models.TblDivision", "Division")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMSystem.Models.TblEmployeBankInformation", b =>
                {
                    ...
                    b.HasOne("HRMSystem.Models.TblEmployeeBasicInfo", "tblEmployeeBasicInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMSystem.Models.TblEmployeeBasicInfo", b =>
                {
                    b.HasOne("HRM_API.Models.TblEmployeeGrade", "TblEmployeeGrade")
                        .WithMany()
                        .HasForeignKey("EmpGradeId");

                    b.HasOne("HRMSystem.Models.TblEmploymentType", "tblEmploymentType")
                        .WithMany()
                        .HasForeignKey("EmploymentTypeId");

                    b.HasOne("HRMSystem.Models.TblPosition", "Position")
                        .WithMany()
                        .HasForeignKey("PositionId");

                    b.HasOne("HRMSystem.Models.TblWorkplaceGroup", "WorkplaceGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("HRM_API.Models.TblEmployeeGrade", b =>
                {
                    b.HasOne("HRMSystem.Models.Account", "Account")
                        .WithMany()
                        .HasForeignKey("IntAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRMSystem.Models.TblPositionGroup", "TblPositionGroup")
                        .WithMany()
                        .HasForeignKey("IntPositionGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Account");

                    b.Navigation("TblPositionGroup");
                });
